...
import { fetchUpcomingGames } from "../Services/RawgServices";
...
const UpcomingGames = () => {
  ...
  if (loading) {
    return <p className="text-center mt-5">Loading Upcoming Games...</p>;
  }
  ...
  return (
    <div className="home dark-scheme">
      ...
      <div className="container mt-5">
        <h2 className="text-center mb-4 text-light">Upcoming Games</h2>
